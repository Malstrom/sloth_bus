class CreditCardsController < ApplicationController
  ...
  def create
    ...
    if @credit_card.save
      redirect_to user_credit_card_url(current_user, @credit_card), notice: "Credit card was successfully created."
    end
  end
  ...
  def update
    respond_to do |format|
      if @credit_card.update(credit_card_params)
        format.html { redirect_to user_credit_card_url(current_user, @credit_card), notice: "Credit card was successfully updated." }
  ...
  def credit_card_params
    params.require(:credit_card).permit( :user, :cardholder, :number, :cvv, :expire_date)
  end
end
